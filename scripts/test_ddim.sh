...
python ./scripts/sr_val_ddim_lensless.py  --init-img data/flatnet_val/inputs --outdir data/flatnet_val/$1  --ckpt logs/2024-01-04T16-36-14_flatnet/checkpoints/last.ckpt --n_samples 2
