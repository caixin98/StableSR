...
python ./scripts/sr_val_ddnm_lensless.py  --init-img data/flatnet_output_val/inputs --outdir data/flatnet_output_val/$1  --ckpt /root/caixin/StableSR/logs/2024-01-04T16-36-19_flatnet_output/checkpoints/last.ckpt --n_samples 4 --precision full 
./scripts/iqa.sh data/flatnet_output_val/$1  data/flatnet_output_val/gts
