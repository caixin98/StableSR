...
rm -rf data/flatnet_val_decode_sim/$1
python ./scripts/sr_val_ddim_lensless.py  --init-img data/flatnet_val_decoded_sim/inputs --outdir data/flatnet_val_decoded_sim/$1  --ckpt /root/caixin/StableSR/logs/2024-03-15T12-49-18_flatnet_decoded_sim/checkpoints/last.ckpt --n_samples 5 --ddim_steps 1000
