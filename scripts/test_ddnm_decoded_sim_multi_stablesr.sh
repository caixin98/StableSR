...
python ./scripts/sr_val_ddpm_ddnm_lensless.py  --init-img data/flatnet_val_multi_decoded_sim_old/inputs --outdir data/flatnet_val_multi_decoded_sim_old/$1  --ckpt /root/caixin/StableSR/ckpts/stablesr_000117.ckpt --n_samples 4   --precision full --ddpm_steps 200 --colorfix_type adain
