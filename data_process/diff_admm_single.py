...
def parse_args():
    ...
    parser.add_argument('--output_name', default='diffusercam-admm', type=str, help='output name')
...
if __name__ == '__main__':
    ...
    source_diffusercam_dir = "/root/caixin/flatnet/data/diffusercam/admm_recon_images"
    output_dir = '../data/%s'%args.output_name + "_val"
    convert_diffusercam_to_single(args, source_diffusercam_dir, output_dir)
