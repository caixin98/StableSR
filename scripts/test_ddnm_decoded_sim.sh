...
python ./scripts/sr_val_ddnm_lensless.py  --init-img data/flatnet_val_decoded_sim/inputs --outdir data/flatnet_val_decoded_sim/$1  --ckpt /root/caixin/StableSR/logs/2024-03-15T12-49-18_flatnet_decoded_sim/checkpoints/last.ckpt --n_samples 4 --precision full 
