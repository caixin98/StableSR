...
python ./scripts/sr_val_ddpm_origin_guidance.py  --init-img data/flatnet_val/inputs --outdir data/flatnet_val/$1 --ddpm_steps 1000 --ckpt logs/2024-01-04T16-36-14_flatnet/checkpoints/last.ckpt --precision full --n_samples 2
