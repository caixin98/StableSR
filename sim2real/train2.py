...
def main(opt):
    ...
    logger = TensorBoardLogger("tb_logs", name="sim2real")
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--sim_capture_path', type=str, default='/root/caixin/data/celebrity_single_optical', help='path to sim capture')
    parser.add_argument('--sim_capture_path', type=str, default='/root/caixin/data/lfw/lfw-deepfunneled-single-optical-random-height', help='path to sim capture')

    parser.add_argument('--real_capture_path', type=str, default='/root/caixin/data/lfw/lfw-deepfunneled-single', help='path to real capture')
